...
-define(CALL_BLACKLIST, [
    {'KeyringManagement', 'ValidateInit'},
    {'KeyringManagement', 'ValidateRekey'},
    {'KeyringManagement', 'ConfirmRekey'},
    {'KeyringManagement', 'ConfirmRotate'},
    {'KeyringManagement', 'ConfirmUnlock'}
]).
-define(RESULT_BLACKLIST, [
    {'KeyringStorage', 'GetKeyring'},
    {'KeyringManagement', 'StartInit'},
